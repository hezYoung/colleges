...
;!function (e) {
    ...
    o.prototype.cache = n, o.prototype.define = function (e, t) {
        ...
        var d = e[0], m = 0;
        if (l = l || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || layui["layui.all"] && u[d] || !layui["layui.all"] && layui["layui.mobile"] && u[d]) return c(), p;
        ...
        var t = this, n = {
            pathname: function () {
                ...
                var n = {}, o = (e ? (e.match(/\?.+/) || [])[0] || "" : location.search).replace(/^\?+/, "").split("&");
