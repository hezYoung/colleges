...
<div id="nav">
    ...
    <div id="menu"> <a id="menu-u0" href="../index.php"> <img id="img-u0" src="../img/u0-0.png"></img>
        ...
        </a> <a id="menu-u2" style="position: absolute;
    background-color: #FFFFFF;
    width: 240px;
    height: 70px;
    top: 140px;
    left: 10px;" href="../college.php"> <img id="img-u2" src="../img/u2-2.png"></img>
        <p id="text-u2">学院管理</p>
        </a> <a id="menu-u3" style=" position: absolute;
    background-color: #6777ef;
    width: 240px;
    height: 70px;
    top: 210px;
    left: 10px;" href="../major.php"> <img id="img-u3" src="../img/u3.png"></img>
        <p id="text-u3">专业管理</p>
