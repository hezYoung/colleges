        ...
        function delete_major(id) {
            layer.open({
                ...
                ,yes: function(index, layero){
                    window.location.href = 'http://localhost/colleges/php/jsoperation.php?operation=deletemajor&id=' + id;
                }
            });
        }

        function modify_major(id){
            window.location.href = 'http://localhost/colleges/php/jsmodifymajor.php?operation=modify&id=' + id;
        }
...
<div id="dw">
    ...
    <a href="php/insertmajor_js.php"> <img src="img/add.png" id="can_img" class="layui-anim layui-anim-scale"></img></a>
    <div id="can" class="layui-anim layui-anim-up">
        <div id="ccan">

            <form method="post" action="jsmajorcx.php">
                <div class="panel admin-panel">
                    <div class="padding border-bottom">
                        <ul class="search" style="padding-left:10px;">
                            <li>
                                <input type="text" placeholder="请输入搜索关键字" name="cxmajor" class="layui-input"
