        ...
        function deleteadmin_js(id) {
            layer.open({
              ...
              ,yes: function(index, layero){
                ...
                window.location.href = 'http://localhost/colleges/php/operation.php?operation=deleteadmin&id=' + id ;
              }
            });
        }

        function modifyadmin_js(id) {
            window.location.href = 'http://localhost/colleges/php/modifyadmin.php?operation=modifyadmin&id=' + id;
        }
