...
$ming = 'select * from cz ';
$ming1 = 'select number from admin';
$result = mysqli_query( $link, $ming );
$result1 = mysqli_query( $link, $ming1 );
?>
<html>
<head>
<meta charset="utf-8">
...
<div id="dw">
    ...
    <div id="low" style=" padding-top: 25px;">
        <div id="bot">
            <p style="color: #98a6ad; font-size: 17px; margin-left: 35px;margin-top: 15px;">2022 © colleges - Powered by PC - php联盟小组 - Version -666</p>
        </div>
    </div>
</div>
