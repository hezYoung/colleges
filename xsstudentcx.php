...
<head>
    ...
    <script>
        ...
        function modify_js(id) {
            window.location.href = 'http://localhost/colleges/php/xsmodify.php?operation=modify&id=' + id;
        }
        ...
        function delete_js(id) {
            layer.open({
                ...
                ,yes: function(index, layero){
                    window.location.href = 'http://localhost/colleges/php/xsoperation.php?operation=delete&id=' + id;
                }
            });
        }
    </script>
...
<div id="nav">
    ...
    <div id="menu">
        ...
        <a id="menu-u1" href="xsstudent.php" style=" position: absolute;
    background-color: #6777ef;
    width: 240px;
    height: 70px;
    top: 70px;
    left: 10px;"> <img id="img-u5" src="img/u5-5.png"></img>
