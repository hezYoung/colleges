...
$ming="SELECT * FROM college,major,class,student WHERE student_num='$i'and student.major_id=major.id and student.college_id=college.id and student.class_id=class.id  ";
...
<head>
    ...
    <script>
        ...
        function modify_js(id) {
            window.location.href = 'http://localhost/colleges/php/jsmodify.php?operation=modify&id=' + id;
        }
        ...
        function delete_js(id) {
            layer.open({
                ...
                ,yes: function(index, layero){
                    window.location.href = 'http://localhost/colleges/php/jsoperation.php?operation=delete&id=' + id;
                }
            });
        }
    </script>
...
<div id="dw">
    ...
    <div id="can">
        ...
        <form method="post" action="studentcx.php">
            <div class="panel admin-panel">
                <div class="padding border-bottom">
                    <ul class="search" style="padding-left:10px;list-style: none;border: 0;">
                        <li>
                            <input type="text" placeholder="请输入搜索关键字" name="cxstudent" class="layui-input"
