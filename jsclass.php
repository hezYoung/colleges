...
<head>
    ...
    <script>
        function modify_class(id) {
            window.location.href = 'http://localhost/colleges/php/jsmodifyclass.php?operation=jsmodify&id=' + id;
        }
        ...
        function delete_class(id) {
            layer.open({
                ...
                yes: function (index, layero) {
                    window.location.href = 'http://localhost/colleges/php/jsoperation.php?operation=jsdeleteclass&id=' + id;
                }
            });
        }
    </script>
...
<div id="nav">
    ...
    <div id="menu"><a id="menu-u0" href="teaindex.php">
