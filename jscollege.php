        ...
        function delete_college(id) {
            layer.open({
                ...
                ,yes: function(index, layero){
                    window.location.href = 'http://localhost/colleges/php/jsoperation.php?operation=deletecollege&id=' + id;
                }
            });
        }

        function modify_college(id){
            window.location.href = 'http://localhost/colleges/php/jsmodifycollege.php?operation=modify&id=' + id;
        }
...
<div id="dw">
    ...
    </div><a href="php/insertcollege_js.php">
