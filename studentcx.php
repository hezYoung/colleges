...
<head>
    ...
    <script>
        ...
        function modify_js(id) {
            window.location.href = 'http://localhost/colleges/php/modify.php?operation=modify&id=' + id;
        }
        ...
        function delete_js(id) {
            layer.open({
                ...
                ,yes: function(index, layero){
                    window.location.href = 'http://localhost/colleges/php/operation.php?operation=delete&id=' + id;
                }
            });
        }
    </script>
