...
$ming="SELECT * FROM college,major,class,student WHERE name ='$a'and student.major_id=major.id and student.college_id=college.id and student.class_id=class.id  ";
...
<div id="dw">
    ...
    <div id="can">
        ...
        <form method="post" action="xsstudentcx.php">
