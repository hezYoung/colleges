...
<div id="nav">
    ...
    <div id="menu">
        ...
        <a id="menu-u1" href="jscollege.php"> <img id="img-u2" src="img/u2-2.png"></img>
            <p id="text-u2">学院管理</p>
        </a>
        <a id="menu-u2" href="jsmajor.php"> <img id="img-u3" src="img/u3-3.png"></img>
            <p id="text-u3">专业管理</p>
        </a>
        <a id="menu-u3" href="jsclass.php"> <img id="img-u4" src="img/u4-4.png"></img>
            <p id="text-u4">班级管理</p>
        </a>
        <a id="menu-u4" href="jsstudent.php"> <img id="img-u5" src="img/u5-5.png"></img>
...
<div id="dw">
    ...
    <div id="con" style="height: 430px; width: 540px ;" class="layui-anim layui-anim-scale">
        <div id="waya">
            ...
            <ul class="aabbcc" id="LAY_demo1"
                style="list-style-type: disc;height: 360px;overflow: auto;width: 500px;margin-top:0px;margin-left: 15px;padding-left: 10px;">
                <li class="layui-timeline-item"><i class="layui-icon layui-timeline-axis"></i>
                    <div class="layui-timeline-content layui-text">
                        <div class="layui-timeline-title">
                            <?php $row = mysqli_fetch_array($result);
                            echo '<b>' . $row['ct'] . '</b> &nbsp;&nbsp;' . $row['cz']; ?>
                        </div>
                    </div>
                </li>
                <li class="layui-timeline-item"><i class="layui-icon layui-timeline-axis"></i>
    ...
    border-radius: 4px;">
        ...
        <p style="color:#a4a6ad;position: absolute;top:118px;left:105px;z-index: 120; font-size: 14px;">
            在这里你可以分别修改此页面菜单栏及头部主题颜色</p>
    </div>
    ...
    <div id="low" style=" padding-top: 25px;">
        <div id="bot">
            <p style="color: #98a6ad; font-size: 17px; margin-left: 35px;margin-top: 15px;">2022 © colleges - Powered by
                PC - php联盟小组 - Version -666</p>
        </div>
    </div>
</div>
<div id="more"><a href="lougout.php" style="text-decoration:none;"> <img src="img/exit.png" id="exit-img" ">
