...
<head>
    ...
    <link href="css/college1.css" rel="stylesheet" type="text/css">
        ...
        function delete_college(id) {
            layer.open({
              ...
              ,yes: function(index, layero){
                window.location.href = 'http://localhost/colleges/php/operation.php?operation=deletecollege&id=' + id;
              }
            });
        }
        
    function modify_college(id){
        window.location.href = 'http://localhost/colleges/php/modifycollege.php?operation=modify&id=' + id;
    }
